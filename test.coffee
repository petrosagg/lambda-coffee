...
testCases =
	...
	testList: ->
		...
		assertTop(listEq(oneTwoThree)(reverse(reverse(oneTwoThree))))
		threeTwoOne = cons(@_3)(cons(@_2)(cons(@_1)(nil)))
		assertTop(listEq(oneTwoThree)(reverse(threeTwoOne)))
		assertTop(listEq(nil)(nil))
		...
		assertTop(listEq(merge(lt)(nil)(nil))(nil))
		assertTop(listEq(merge(lt)(nil)(oneTwoThree))(oneTwoThree))
		assertTop(listEq(merge(lt)(oneTwoThree)(nil))(oneTwoThree))
		assertTop(listEq(merge(lt)(oneTwoThree)(twoFourSix))(oneTwoTwoThreeFourSix))
		twoFour = filter((x) => isZero mod(x)(@_2))(twoThreeFour)
		assertTop(eq(head(leftHalf twoFour))(@_2))
		assertTop(eq(head(rightHalf twoFour))(@_4))
		assertTop(listEq(leftHalf oneTwoTwoThreeFourSix)(cons(@_1)(cons(@_2)(cons(@_2)(nil)))))
		assertTop(listEq(rightHalf oneTwoTwoThreeFourSix)(cons(@_3)(cons(@_4)(cons(@_6)(nil)))))
		assertTop(listEq(leftHalf oneTwoThree)(cons(@_1)(nil)))
		assertTop(listEq(rightHalf oneTwoThree)(pair(@_2)(@_3)))
		assertTop(isEmpty(leftHalf nil))
		assertTop(isEmpty(rightHalf nil))
		assertTop(isEmpty(leftHalf cons(@_1)(nil)))
		assertTop(listEq(mergesort(lt)(pair(@_4)(@_3)))(pair(@_3)(@_4)))
		assertTop(listEq(mergesort(gt)(oneTwoTwoThreeFourSix))(reverse(oneTwoTwoThreeFourSix)))
